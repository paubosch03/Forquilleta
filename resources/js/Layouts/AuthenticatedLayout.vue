    ...
    <div>
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-gray-700 border-b border-gray-300">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div v-if="$page.props.auth.user" class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('restaurantes')" :active="route().current('restaurantes')"
                                    class="text-white">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('restauranteReview')"
                                    :active="route().current('restauranteReview')" class="text-white">
                                    Review
                                </NavLink>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('restauranteMap')" :active="route().current('restauranteMap')"
                                    class="text-white">
                                    Maps
                                </NavLink>
                            </div>
                ...
                <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown }"></div>
                    class="sm:hidden">
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            <ResponsiveNavLink :href="route('profile.edit')" class="text-white"> Profile
                            </ResponsiveNavLink>
